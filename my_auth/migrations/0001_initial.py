    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialty', models.CharField(choices=[('Calculus (FYE)', 'Calculus (FYE)'), ('Information Technology', 'Information Technology'), ('Algebra (FYE)', 'Algebra (FYE)')], default='Mathematics', max_length=400)),
                ('bio', models.TextField(blank=True, null=True)),
                ('image', models.ImageField(default='profile_pics/default.png', upload_to='profile_pics')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='my_auth.newuser')),
            ],
            options={
